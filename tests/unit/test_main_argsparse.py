...
class TestMain(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.parser = get_args_parser(test=True)
    ...
    def test_folder_not_exist(self):
        for cmd in ["-i /_no_way_this_folder_exist -o /out --salt 120 --log-folder /tmp",
                    "-i /tmp -o /out --salt 120 --log-folder /__no_way_this_folder_exist"]:
            try:
