...
from obfuscator.lib.detectors import CredentialFilth, FilesDirFilth
from obfuscator.lib import utils
from .abs_file_splitter import FileSplitters
from obfuscator.lib.enums import SegmentsEnum
...
class LowLevelFilth:
    ...
    def replace_with(self, text):
        return f"{{{{{self.placeholder}-{utils.hash_string(f'{self._const_hash}{text}')}}}}}"
