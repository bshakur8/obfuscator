...
from obfuscator.lib.detectors import ObfuscatorDetectors
from obfuscator.lib.scrubber import ObfuscatorScrubber
...
class ObfuscateSplitAndMerge(FileSplitters):
    ...
    def obfuscate_one(self, *args, **kwargs):
        ...
        line_idx = 0
        try:
            with open(tmp_fd, "w", buffering=utils.DEFAULT_BUFFER_SIZE, encoding="utf-8") as writer, open(
            ...
            with open(err_tmp_fd, "w", encoding="utf-8") as writer:
